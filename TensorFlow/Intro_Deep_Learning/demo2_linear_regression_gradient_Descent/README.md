...
We'll draw the line of best fit to measure the relationship between student test scores and the amount of hours studied.
linear regression :线性回归 -- linear regression is just ML there are no neural network 
